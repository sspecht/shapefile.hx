...
class DbfTools {
	 ...
	 * 
	 */
	static public function readZeroTermANSIString(src : ByteArray) : String {
		var r : String = "";
		var b : Int;
	 ...
	 * 
	 */
	static public function readANSIString(src : ByteArray, length : UInt) : String {
		var r : String = "";
		while(length--) {
	 ...
	 * 
	 */
	static public function getRecord(src : ByteArray, header : DbfHeader, index : UInt) : DbfRecord {
