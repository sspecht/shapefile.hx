...
class ShpRecord {
	...
	public function new(src : ByteArray) {
		...
		case ShpType.SHAPE_MULTIPATCH, ShpType.SHAPE_MULTIPOINT, ShpType.SHAPE_MULTIPOINTM, ShpType.SHAPE_MULTIPOINTZ, ShpType.SHAPE_POINTM, ShpType.SHAPE_POLYGONM, ShpType.SHAPE_POLYGONZ, ShpType.SHAPE_POLYLINEZ, ShpType.SHAPE_POLYLINEM:
